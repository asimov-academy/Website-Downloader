...
MAX_CONCURRENT_BROWSERS = _get_int('DM_MAX_CONCURRENT_BROWSERS', 2)
BROWSER_LAUNCH_RETRIES = _get_int('DM_BROWSER_LAUNCH_RETRIES', 3)
BROWSER_LAUNCH_RETRY_DELAY_S = _get_float('DM_BROWSER_LAUNCH_RETRY_DELAY_S', 2.0)
